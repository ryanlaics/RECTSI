...
class PandasDataset:
    def __init__(self, dataframe: pd.DataFrame, u: pd.DataFrame = None, name='pd-datasets', mask=None, freq=None,
                 aggr='sum', **kwargs):
        """
        Initialize a tsl datasets from a pandas dataframe.


        :param dataframe: dataframe containing the data, shape: n_steps, n_nodes
        :param u: dataframe with exog variables
        :param name: optional name of the datasets
