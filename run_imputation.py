...
def parse_args():
    ...
    # parser.add_argument("--datasets-name", type=str, default='air36')
    # parser.add_argument("--subdataset-name", type=str, default='air36')
    #
    # parser.add_argument("--datasets-name", type=str, default='covid_point')
    # parser.add_argument("--subdataset-name", type=str, default='air36')
    parser.add_argument("--datasets-name", type=str, default='pems_point')
    parser.add_argument("--subdataset-name", type=str, default='PEMS07')
...
def run_experiment(args):
    ...
    # batch_size = 1
    # x_shape = (batch_size, 24, 192)
    # mask_shape = (batch_size, 24, 64)
    # # x_shape = (batch_size, args.window, 108)
    # # mask_shape = (batch_size, args.window, 36)
    # # x_shape = (batch_size, 14, 168)
    # # mask_shape = (batch_size, 14, 56)
    # # adj_shape = (batch_size, 36, 36, 36)
    # # pos_shape = (batch_size, 36,36, 5)
    # # timestamp_shape = (batch_size, 36, 1)
    # input_data = {
    #     'x': torch.rand(x_shape),
    #     'mask': torch.zeros(mask_shape)
    #     # 'adj': torch.rand(adj_shape),
    #     # 'pos': torch.rand(pos_shape),
    #     # 'timestamp': torch.rand(timestamp_shape)
    # }
    # summary(filler, input_data=input_data)
    # import time
    # a = torch.rand(x_shape)
    # b = torch.zeros(mask_shape)
    # #
    # #
